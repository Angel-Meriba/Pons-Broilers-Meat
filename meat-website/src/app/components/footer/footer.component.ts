            ...
            <div class="footer-section">
              ...
              <ul class="contact-info">
                ...
                <li>
                  ...
                  <span>97, Servaikarar Street near Mattabadai Bazaar, Tuticorin - 628001</span>
                </li>
                <li>
                  <i class="bi bi-telephone"></i>
                  <span>
                    <a href="tel:+917904294113">+91 7904294113</a>,
                    <a href="tel:+917904312330">+91 7904312330</a>
                  </span>
                </li>
                <li>
        ...
        <div class="container">
          <div class="payment-wrapper">
            ...
            <div class="payment-icons">
              ...
              <i class="bi bi-cash-stack" title="Cash on Delivery"></i>
              <i class="bi bi-bank" title="Net Banking"></i>
              <i class="bi bi-upc-scan" title="UPI"></i>
            </div>
          </div>
        </div>
      </div>
